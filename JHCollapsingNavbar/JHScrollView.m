...
-(void)userDidPan:(UIPanGestureRecognizer *)panGesture {
    ...
    if (panGesture.state != UIGestureRecognizerStateEnded) {
        ...
        if ([self.collapsingView checkIsAllowedToMove:self.translation.y withGesture:panGesture withScrollView:self]) {
        ...
        [self.collapsingView snapViewWithScrollView:self andPanGesture:self.panGesture];
